...
import (
	...
	"github.com/GermanBogatov/youtube_service/internal/events/model/response"
	"github.com/GermanBogatov/youtube_service/internal/spotify"
...
func NewWorker(id int, client mq.Consumer, responseQueue string, producer mq.Producer, messages <-chan mq.Message,
	logger *logging.Logger, service *spotify.Service, wg *sync.WaitGroup) Worker {
